export default function PrivacyPolicy() {
  return (
    <main className="mx-auto max-w-3xl px-4 py-10 text-zinc-100">
      ...
      <h2 className="text-xl font-medium mt-6 mb-2">Cookies e Dados de Utilização</h2>
      <p className="mb-4 text-sm text-zinc-300">
      ...
      <h2 className="text-xl font-medium mt-6 mb-2">Consentimento</h2>
      <p className="mb-4 text-sm text-zinc-300">
      ...
      <h2 className="text-xl font-medium mt-6 mb-2">Contacto</h2>
      <p className="mb-4 text-sm text-zinc-300">
